...
function setup() {
  ...
  $.getJSON("data/v0.9.json", function(data) {
    if (data != null) {
...
function mousePressed() {
  ...
  shapeRadius = map(constrain(mouseX, 0, width), 0, width, 5, 20);
  ...
  var shape = new TriangleFan(mouseX, mouseY, floor(random(20, 50)), random(-0.005, 0.005), shapeRadius, shapeOpacity, random(1));
  shapes.push(shape);
}
